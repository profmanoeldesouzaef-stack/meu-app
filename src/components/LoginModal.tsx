    ...
    <div className="fixed inset-0 z-50 bg-[#0A0A0A] flex items-center justify-center p-4">
      <div className="w-full max-w-md rounded-3xl bg-[#151515] border border-[#2B2B2F] p-8 space-y-6 text-center shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div>
          ...
          <p className="text-xs text-[#9B9BA1] mt-2">
            Entre com seu e-mail cadastrado para acessar o seu perfil.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          ...
          {feedback && (
            <div className="p-3 rounded-xl bg-[#6D9BFF]/10 border border-[#6D9BFF]/30 text-[#6D9BFF] text-xs font-semibold text-center">
              {feedback}
            </div>
          )}
