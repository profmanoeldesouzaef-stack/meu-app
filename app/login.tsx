...
export default function Login() {
  ...
  const loginWithGoogle = () => {
    // Aqui entrará a lógica de autenticação do Google via Supabase OAuth
    proceed();
  };
    ...
    <View style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      >
        ...
        <View style={styles.card}>
          ...
          <Pressable testID="google-login-button" onPress={loginWithGoogle} style={styles.googleBtn}>
            <Ionicons name="logo-google" size={20} color="#F5F5F7" />
...
const styles = StyleSheet.create({
  ...
  primary: { height: 52, borderRadius: radius.lg, alignItems: "center", justifyContent: "center", marginTop: spacing.sm },
  ...
  dividerText: { color: "#9B9BA1", marginHorizontal: spacing.sm, fontSize: fs.sm },
  googleBtn: { height: 52, borderRadius: radius.lg, borderWidth: 1, borderColor: "#2B2B2F", backgroundColor: "#1D1D1F", flexDirection: "row", alignItems: "center", justifyContent: "center", gap: spacing.sm },
  googleBtnText: { color: "#F5F5F7", fontSize: fs.lg, fontWeight: "600" },
